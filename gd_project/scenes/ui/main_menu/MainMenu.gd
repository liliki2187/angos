...
const SETTLEMENT_MODAL_SCENE_PATH := "res://scenes/ui/modals/MysteryBroadsheetModal.tscn"
...
func _ready():
	...
	btn_new.pressed.connect(_on_goto_weekly_run)
...
func _on_goto_cards():
	var path := str(Globals.scene_paths.get("card_collection", "res://scenes/gameplay/card_collection/CardCollection.tscn"))
...
func _on_goto_check():
	var path := str(Globals.scene_paths.get("event_check", "res://scenes/gameplay/event_check/EventCheck.tscn"))
