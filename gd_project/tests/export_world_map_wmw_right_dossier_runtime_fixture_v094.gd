...
const OUT_PATH := "res://Assets/ui/angus_packaging/world_map/wmw_v094_right_dossier_candidate_a4/right_dossier_candidate_a4_runtime_fixture.json"
...
func _export_fixture() -> void:
	...
	var fixture := {
		"schema_version": 1,
		"candidate": "right_dossier_candidate_a4_v0.9.4",
