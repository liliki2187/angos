...
const OUT_PATH := "res://Assets/ui/angus_packaging/world_map/wmw_v092_right_dossier_candidate_a2/right_dossier_candidate_a2_runtime_fixture.json"
...
func _export_fixture() -> void:
	...
	var fixture := {
		"schema_version": 1,
		"candidate": "right_dossier_candidate_a2_v0.9.2",
		...
		"mission_intel_label": "查看任务情报 · %d项" % int(counts["visible"]),
		"primary_enter_label": "进入选定地区" if unlocked else "暂不可进入",
	}
