    ...
    await showWeek1SoftTutorialModal(
      ...
      [
        `${tutorialSoftFigure(
          ...
          <p class="tutorial-soft-lead">左侧是您带回的<strong>现象、认知、情报、工具</strong>；右侧卡槽决定本周要出哪类稿件。</p>
        </div>`,
        `<div class="tutorial-soft-sheet">
          <h4 class="tutorial-soft-h4">槽位颜色</h4>
          <ul class="tutorial-soft-ul">
            <li><strong>公开报道</strong>：按<strong>红色</strong>槽放入必需素材；<strong>金色虚线</strong>槽可放工具，略抬成功率。</li>
            <li><strong>内审定调</strong>（蓝色）：用现象定编辑部口径，生成同主题「认知」供后续用，<strong>不直接上版</strong>。</li>
          </ul>
        </div>`,
        `<div class="tutorial-soft-sheet">
