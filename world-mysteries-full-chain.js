(function () {
  ...
  /** 全球地图引导页：示意插图（Assets/tutorial-map-guide.svg） */
  const TUTORIAL_MAP_GUIDE_FIGURE = `<div class="tutorial-soft-figure" style="margin:0 0 0.65rem;border:1px solid var(--line);border-radius:10px;overflow:hidden;background:#0b1220;">
<img src="Assets/tutorial-map-guide.svg" alt="取材地图示意：左侧为可点区域，右侧为区域情报列表，二者可联动高亮" style="display:block;width:100%;max-height:min(30vh,220px);height:auto;object-fit:contain;" />
<p style="margin:0;padding:8px 10px;font-size:0.72rem;color:var(--muted);line-height:1.45;border-top:1px solid var(--line);">上图为界面结构示意（非您本局实时画面）。左：点陆块上的区域；右：「区域情报」与地图点位对应，可联动高亮。</p>
</div>`;

  /** 报刊组版实验 · 多页（最多 5 页） */
  const LAB_FULL_GUIDE_PAGES = [
    `<p style="margin:0;line-height:1.6;">主编您好。这里是《世界未解之谜周刊》的<strong>组版练习场</strong>：我们暂时跳过出门采访和成稿台，让您先熟悉「报纸长什么样、稿子怎么上桌」。</p>`,
    `<p style="margin:0;line-height:1.6;">在完整周刊里，流程是：<strong>回合札记 → 世界地图取材 → 合成台成稿 → 编辑部组版</strong>。本页只练最后一步，和正式第一周组版用的是同一套版心与操作习惯。</p>`,
    `<p style="margin:0;line-height:1.6;">关窗后会自动播放一则<strong>填入动画示例</strong>（稿件飞入头版，可循环）。需要重温时，可在工具栏打开「报刊填入演示」。<span style="color:var(--muted);font-size:0.88rem;">本提示在刷新页面前只出现一次。</span></p>`,
  ];
...
<div class="nm-tip" style="margin-top:6px;font-size:11px;padding:6px;">拖到中间头版版位</div>`;
  ...
  async function runWeek1EditorialOnboarding() {
    ...
    await showWeek1SoftTutorialModal(
      ...
      "第一周 · 编辑部组版",
      [
        `<p style="margin:0;line-height:1.6;">主编，成稿已经备好。请把左侧<strong>故事库</strong>里的卡片<strong>拖进</strong>中间报纸的版位——<strong>头版</strong>最吸睛，<strong>内页</strong>略逊一筹，都会算进本期曝光。</p>`,
        `<p style="margin:0;line-height:1.6;">版式满意后点<strong>结算本期</strong>，看这一周的销量与利润。关窗后会播一段<strong>填入演示</strong>（可循环）；也可点「报刊填入演示」重温。<span style="color:var(--muted);font-size:0.88rem;">本周内本提示只出现一次。</span></p>`,
      ],
    );
    if (!week1TutorialActive() || state.phase !== "editorial" || state.paperLabMode) return;
    openPaperDemoLab();
  ...
  async function runWeek1SynthesisOnboarding() {
    ...
    await showWeek1SoftTutorialModal(
      ...
      "第一周 · 故事合成台",
      [
        `<p style="margin:0;line-height:1.6;">主编，这里是<strong>故事合成台</strong>：左侧是您带回的现象、认知、情报和工具；右侧卡槽决定「这一版周刊要出哪一种公开报道」。</p>`,
        `<p style="margin:0;line-height:1.6;"><strong>公开报道</strong>：按<strong>红色</strong>槽位放入必需素材；<strong>金色虚线</strong>可放工具。<strong>内审定调</strong>（蓝色）：现象→认知，可选<strong>主笔人物</strong>提高高等级认知概率（承担 SAN）；认知需先内审再用于深度/专栏等。<strong>抢先快讯</strong>不需认知。</p>`,
        `<p style="margin:0;line-height:1.6;"><strong>爆炸性新闻</strong>需要专用<strong>爆料卡</strong>（在左侧「爆料卡」分类；来自探索，无法靠合成「做出来」）。</p>`,
        `<p style="margin:0;line-height:1.6;">关窗后会自动播<strong>拖拽示意</strong>；需要时也可点「合成拖拽演示」。<span style="color:var(--muted);font-size:0.88rem;">本周内本提示只出现一次。</span></p>`,
      ],
    );
    if (!week1TutorialActive() || state.phase !== "synthesis" || state.paperLabMode) return;
    openSynthDemoLab();
  ...
  function renderWeekStart() {
    ...
    scheduleWeek1SoftTutorial(
      ...
      "第一周 · 编辑部札记",
      [
        `<p style="margin:0;line-height:1.6;">主编，新一周从<strong>编辑部札记</strong>开始：这里会冒出本周的小插曲或突发消息。您读完标题与正文，按提示处理即可——有时只需确认，有时要在几个走向里选一条。<strong>您的选择可能会有不同的后果。</strong></p>`,
        `<p style="margin:0;line-height:1.6;">处理完札记后，请点<strong>进入全球地图</strong>，编辑部要派您去各地「挖料」了。<span style="color:var(--muted);font-size:0.88rem;">点「知道了」或空白处可关窗；本周内同类提示不再弹出，新周目第一周会再出现。</span></p>`,
      ],
    );
  }
  ...
  function renderGlobal() {
    ...
    scheduleWeek1SoftTutorial(
      ...
      "第一周 · 世界取材地图",
      [
        `${TUTORIAL_MAP_GUIDE_FIGURE}<p style="margin:0;line-height:1.6;">这是您的<strong>取材地图</strong>，即您当前可以探索的地域：点陆块上的<strong>区域</strong>进入当地版面。右侧情报列表会与地图上的点位<strong>联动高亮</strong>，方便您对号入座。</p>`,
        `<p style="margin:0;line-height:1.6;">顶部的 <strong>科学 / 秘闻 / 大众</strong> 标签用来筛一筛题材口味，减少无关目标干扰。</p>`,
        `<p style="margin:0;line-height:1.6;"><strong>下一天</strong>可用本页右侧大按钮、区域内同款按钮，或屏幕<strong>左下角悬浮按钮</strong>；时间会推进，到期的外派会依次结算。<span style="color:var(--muted);font-size:0.88rem;">本周内本提示只出现一次。</span></p>`,
      ],
    );
  }
  ...
  function renderRegion() {
    ...
    scheduleWeek1SoftTutorial(
      ...
      "第一周 · 区域版面",
      [
        `<p style="margin:0;line-height:1.6;">进入区域后，图例上的 <strong>常 / 隐 / !</strong> 大致表示常驻点、隐藏点和临时热点；已经派人手的格子会标<strong>派</strong>字，避免重复踩坑。</p>`,
        `<p style="margin:0;line-height:1.6;">点开一条线后，右侧可<strong>组小队</strong>。请看「调查」「现场」两侧的骰数门槛——凑够再派遣更稳妥；不够也能去，但成功率会吃亏。</p>`,
        `<p style="margin:0;line-height:1.6;"><strong>线索</strong>类条目走调查流程，跑通有机会<strong>解锁新节点</strong>。<span style="color:var(--muted);font-size:0.88rem;">关窗后本周不再用弹窗打断您。</span></p>`,
      ],
    );
  }
  ...
  function renderSetup() {
    ...
    scheduleWeek1SoftTutorial(
      ...
      "第一周 · 组队与出发",
      [
        `<p style="margin:0;line-height:1.6;">请点选队员卡片组成小队（最多 5 人）。上方概率是本次外拍的参考；可在<strong>骰子</strong>与<strong>纯数字</strong>两种展示间切换，看哪种更顺眼。</p>`,
        `<p style="margin:0;line-height:1.6;">点<strong>派遣</strong>后，任务会占用本周若干天；到期的日子请用<strong>下一天</strong>推进，系统会依次播报结果。您按自己的节奏操作即可，不必为引导多点无关按钮。<span style="color:var(--muted);font-size:0.88rem;">本周内本提示只出现一次。</span></p>`,
      ],
    );
  }
    ...
    if (week1TutorialActive() && !state.tutorialSoftW1.w1_result) {
      if (tutorialsGloballyDisabled()) {
        ...
        await showWeek1SoftTutorialModal(
          ...
          "第一周 · 外拍结算",
          [
            `<p style="margin:0;line-height:1.6;">主编，这是本次外拍的<strong>双线结果</strong>：「调查」与「现场」各自过线，合在一起决定是大获全胜、平稳交差、失手还是闹大。奖励弹窗可逐条翻看。</p>`,
            `<p style="margin:0;line-height:1.6;">点<strong>继续</strong>：若本周还有天数，会回到区域；若本周时间用尽，编辑部会请您进<strong>合成台</strong>把料收成稿。<span style="color:var(--muted);font-size:0.88rem;">关窗后本周不再重复本提示。</span></p>`,
          ],
        );
      }
    }
