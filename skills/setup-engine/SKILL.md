---
name: setup-engine
description: "Configure the project's game engine and version. Pins the engine in project docs, detects knowledge gaps, and populates engine reference docs via WebSearch when the version is beyond the LLM's training data."
---

## Codex Notes

- Treat references like /setup-engine or /other-skill as Codex skill names. For example, use $setup-engine for this workflow.
