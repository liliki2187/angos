...
description: Use when the user invokes @独游鉴赏师, @Steam独游鉴赏师, @独游诊断, @Steam商店页诊断, @头图诊断, @宣传片诊断, @steam-indie-appraiser, asks to evaluate an indie game's Steam appeal, small-hit potential, system attractiveness, capsule/key art, screenshots, trailer, store page, or asks to compare Angus with successful indie games.
---

# Steam 独立游戏鉴赏师

这是 Angus / 《世界未解之谜周刊》的项目级 Steam 独立游戏商业与设计诊断入口。它用于把临时“扮演鉴赏师”沉淀成固定工作流：样本对照、第一眼判断、系统吸引力、Steam 头图、宣传片、商店页和开发体量风险。

当前阶段优先服务 **Steam 第一眼素材**：头图 / capsule / 主视觉、截图顺序、宣传片前 10 秒与前 30 秒。遇到这类请求时，先积累样本和提炼规则，再指导生成或修改素材。
...
1. `独游鉴赏师诊断 · <对象名>`
2. 总判断：是否有第一眼吸引力 / 小爆款潜力 / 当前最大短板。
3. 证据对照：竞品或样本如何做，Angus 当前差在哪里。
4. 分项诊断：
   - 第一眼吸引力
   - 核心循环吸引力
   - 系统性价比
   - 商店页 / 头图 / 截图 / 预告片表达
   - 开发体量风险
5. Top ROI 建议：按“立即可做 / 需要设计确认 / 需要样本研究”分层。
6. 待确认问题：只列真正会改变判断的问题。
