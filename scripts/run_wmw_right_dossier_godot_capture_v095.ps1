...
$captureScript = 'res://tests/capture_world_map_wmw_right_dossier_runtime_v095.gd'
...
Write-Host 'Running WMW v0.9.5 right-dossier candidate A5 capture (windowed opengl3)...'
& $godot --path $projectPath --resolution 1920x1080 --windowed --audio-driver Dummy --rendering-driver opengl3 -s $captureScript
if ($LASTEXITCODE -ne 0) {
    throw 'WMW v0.9.5 right-dossier candidate A5 Godot capture failed.'
}

$expected = @(
    '623-world-map-wmw-v0-9-5-right-dossier-candidate-a5-godot-collapsed.png',
    '624-world-map-wmw-v0-9-5-right-dossier-candidate-a5-godot-expanded.png',
    '625-world-map-wmw-v0-9-5-right-dossier-candidate-a5-godot-qa.png'
)
...
Write-Host 'WMW v0.9.5 right-dossier candidate A5 Godot capture passed.'
