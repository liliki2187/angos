...
$captureScript = 'res://tests/capture_world_map_wmw_right_dossier_runtime_v096.gd'
...
Write-Host 'Running WMW v0.9.6 right-dossier candidate A5.1 capture (windowed opengl3)...'
& $godot --path $projectPath --resolution 1920x1080 --windowed --audio-driver Dummy --rendering-driver opengl3 -s $captureScript
if ($LASTEXITCODE -ne 0) {
    throw 'WMW v0.9.6 right-dossier candidate A5.1 Godot capture failed.'
}

$expected = @(
    '633-world-map-wmw-v0-9-6-right-dossier-candidate-a5-1-godot-collapsed.png',
    '634-world-map-wmw-v0-9-6-right-dossier-candidate-a5-1-godot-expanded.png',
    '635-world-map-wmw-v0-9-6-right-dossier-candidate-a5-1-godot-qa.png'
)
...
Write-Host 'WMW v0.9.6 right-dossier candidate A5.1 Godot capture passed.'
