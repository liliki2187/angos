  ...
  async function runWeek1SynthesisOnboarding() {
    ...
    await showWeek1SoftTutorialModal(
      ...
      [
        ...
        `<p style="margin:0;line-height:1.6;"><strong>公开报道</strong>：按<strong>红色</strong>槽位提示放入必需素材；<strong>金色虚线</strong>槽可放工具，略抬成功率。<strong>内审定调</strong>（蓝色）：用现象定编辑部口径，生成同主题的「认知」供后续使用，<strong>不直接上版</strong>。</p>`,
